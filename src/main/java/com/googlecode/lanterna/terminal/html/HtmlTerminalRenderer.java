...
public final class HtmlTerminalRenderer {
    ...
    private static String renderTemplate(
        ...
        body.append("<body data-lanterna-terminal=\"true\" data-transport=\"").append(transport)
                ...
                .append(live ? "" : "<nav id=\"review-controls\" aria-label=\"Static frame viewing\">"
                        + "<span>Static frame</span><button type=\"button\" id=\"fit-width\" aria-pressed=\"true\">Fit width</button>"
                        + "<button type=\"button\" id=\"actual-size\" aria-pressed=\"false\">Actual size</button></nav>")
                .append("<div id=\"viewport\"").append(live ? "" : " tabindex=\"0\" aria-label=\"Terminal frame scroll area\"")
                .append("><div id=\"canvas\"><div id=\"terminal\" role=\"")
                .append(live ? "application" : "region").append("\" ")
                ...
                .append("</div></div></div>")
                .append("<textarea id=\"input\"").append(live ? "" : " disabled tabindex=\"-1\"")
                .append(" aria-label=\"Terminal keyboard input\" autocomplete=\"off\" ")
